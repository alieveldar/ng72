...
lib.ssMetadata = [
		{name:"elki_atlas_", frames: [[602,696,650,720],[0,0,600,974],[602,0,816,694],[0,1418,977,472]]}
];
...
(lib.елка1 = function() {
	this.spriteSheet = ss["elki_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.elki = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// елка
	this.instance = new lib.Символ7();
	this.instance.parent = this;
	this.instance.setTransform(180.3,355.3,0.999,0.999,163.2,0,0,203.3,300.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:162.1,regY:168.7,scaleX:1,scaleY:1,rotation:134.7,x:302.7,y:418.6},0).wait(1).to({rotation:106.4,x:318,y:353},0).wait(1).to({rotation:78.1,x:300.4,y:288},0).wait(1).to({rotation:49.8,x:254.2,y:239},0).wait(1).to({rotation:21.5,x:190.2,y:217.9},0).wait(1).to({rotation:-6.8,x:123.9,y:229.6},0).wait(1).to({rotation:-4.3,x:129.3,y:227.3},0).wait(1).to({rotation:-1.9,x:134.8,y:225.3},0).wait(1).to({rotation:-1.8,x:134.9,y:225.2},0).wait(1).to({x:135},0).wait(1).to({rotation:-1.7,x:135.1},0).wait(1).to({x:135.3,y:225.1},0).wait(1).to({rotation:-1.6,x:135.4},0).wait(1).to({x:135.5},0).wait(1).to({rotation:-1.5,x:135.6,y:225},0).wait(1).to({x:135.7},0).wait(1).to({x:135.8},0).wait(1).to({rotation:-1.4,x:135.9,y:224.9},0).wait(1).to({x:136},0).wait(1).to({rotation:-1.3,x:136.1,y:224.8},0).wait(1).to({x:136.2},0).wait(1).to({rotation:-1.2,x:136.3},0).wait(1).to({x:136.4,y:224.7},0).wait(1).to({rotation:-1.1,x:136.5},0).wait(1).to({x:136.6,y:224.6},0).wait(1).to({rotation:-1,x:136.8},0).wait(1).to({x:136.9,y:224.5},0).wait(1).to({rotation:-0.9,x:137,y:224.6},0).wait(1).to({x:137.1},0).wait(1).to({rotation:-0.8,x:137.2,y:224.5},0).wait(1).to({x:137.3},0).wait(1).to({rotation:-0.7,x:137.4,y:224.4},0).wait(1).to({x:137.5},0).wait(1).to({x:137.7,y:224.3},0).wait(1).to({rotation:-0.6,x:137.8},0).wait(1).to({x:137.9},0).wait(1).to({rotation:-0.5,y:224.2},0).wait(1).to({x:138},0).wait(1).to({rotation:-0.4,x:138.2},0).wait(1).to({x:138.3,y:224.1},0).wait(1).to({rotation:-0.3,x:138.4},0).wait(1).to({x:138.5,y:224},0).wait(1).to({rotation:-0.2,x:138.6},0).wait(1).to({x:138.7},0).wait(1).to({rotation:-0.1,x:138.8,y:223.9},0).wait(1).to({x:138.9},0).wait(1).to({rotation:0,x:139},0).wait(1).to({x:139.2,y:223.8},0).wait(1).to({rotation:0.1,x:139.3},0).wait(2).to({x:139.4,y:223.7},0).wait(1).to({rotation:0.2,x:139.6},0).wait(1).to({x:139.7},0).wait(1).to({rotation:0.3,x:139.8,y:223.6},0).wait(1).to({x:139.9},0).wait(1).to({rotation:0.4,x:140},0).wait(1).to({x:140.1,y:223.5},0).wait(1).to({rotation:0.5,x:140.2},0).wait(1).to({x:140.3},0).wait(1).to({rotation:0.6,x:140.4,y:223.4},0).wait(1).to({x:140.6},0).wait(1).to({rotation:0.7,x:140.7},0).wait(1).to({x:140.8},0).wait(1).to({rotation:0.8,x:140.9,y:223.3},0).wait(1).to({x:141},0).wait(1).to({rotation:0.9,x:141.1},0).wait(1).to({x:141.2},0).wait(1).to({x:141.3,y:223.2},0).wait(1).to({rotation:56.2,x:266.7,y:248},0).wait(1).to({rotation:111.5,x:317.7,y:365.2},0).wait(1).to({rotation:166.8,x:250.5,y:473.8},0).to({_off:true},1).wait(68));
	...
	this.instance_5.setTransform(184.6,400.2,0.915,0.915,118.8,0,0,238.8,376.9);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(70).to({_off:false},0).wait(1).to({regX:173.7,regY:217,scaleX:0.92,scaleY:0.92,rotation:98.2,x:338,y:362},0).wait(1).to({rotation:77.6,x:314.8,y:310.5},0).wait(1).to({rotation:57,x:274.9,y:270.5},0).wait(1).to({rotation:36.4,x:223.4,y:247.1},0).wait(1).to({rotation:15.8,x:167.1,y:243.1},0).wait(1).to({rotation:-4.8,x:113,y:259.3},0).wait(1).to({rotation:-3.1,x:117.1,y:257.3},0).wait(1).to({rotation:-1.4,x:121.3,y:255.4},0).wait(1).to({x:121.4},0).wait(1).to({rotation:-1.3,x:121.5,y:255.3},0).wait(1).to({x:121.6},0).wait(1).to({x:121.8,y:255.2},0).wait(1).to({rotation:-1.2,x:121.9},0).wait(1).to({x:122,y:255.1},0).wait(1).to({rotation:-1.1,x:122.1},0).wait(1).to({x:122.2,y:255},0).wait(1).to({x:122.3},0).wait(1).to({rotation:-1,x:122.4,y:254.9},0).wait(2).to({rotation:-0.9,x:122.6,y:254.8},0).wait(1).to({x:122.7},0).wait(1).to({rotation:-0.8,x:122.8,y:254.7},0).wait(1).to({x:122.9},0).wait(1).to({x:123},0).wait(1).to({rotation:-0.7,x:123.1},0).wait(1).to({x:123.2,y:254.6},0).wait(1).to({rotation:-0.6,x:123.4,y:254.5},0).wait(1).to({x:123.5},0).wait(1).to({x:123.6},0).wait(1).to({rotation:-0.5,x:123.7,y:254.4},0).wait(1).to({x:123.8},0).wait(1).to({rotation:-0.4,x:123.9,y:254.3},0).wait(1).to({x:124},0).wait(1).to({x:124.1,y:254.2},0).wait(1).to({rotation:-0.3,x:124.2},0).wait(1).to({x:124.3,y:254.1},0).wait(1).to({rotation:-0.2,x:124.4},0).wait(1).to({x:124.5},0).wait(1).to({rotation:-0.1,x:124.6,y:254},0).wait(1).to({x:124.7},0).wait(1).to({x:124.8},0).wait(1).to({rotation:0,x:124.9,y:253.9},0).wait(1).to({x:125,y:253.8},0).wait(1).to({rotation:0.1,x:125.1},0).wait(1).to({x:125.2},0).wait(1).to({x:125.3,y:253.7},0).wait(1).to({rotation:0.2,x:125.4},0).wait(1).to({x:125.5},0).wait(1).to({rotation:0.3,x:125.7,y:253.6},0).wait(1).to({x:125.8,y:253.5},0).wait(1).to({x:125.9},0).wait(1).to({rotation:0.4,x:126},0).wait(1).to({x:126.1,y:253.4},0).wait(1).to({rotation:0.5,x:126.2},0).wait(1).to({x:126.3},0).wait(1).to({rotation:0.6,x:126.4,y:253.3},0).wait(1).to({x:126.5},0).wait(1).to({x:126.6,y:253.2},0).wait(1).to({rotation:0.7,x:126.7},0).wait(1).to({x:126.8,y:253.1},0).wait(1).to({rotation:0.8,x:126.9},0).wait(1).to({x:127},0).wait(1).to({x:127.1,y:253},0).wait(1).to({rotation:0.9,x:127.2,y:252.9},0).wait(1).to({x:127.3},0).wait(1).to({rotation:32.2,x:212.1,y:244.6},0).wait(1).to({rotation:63.5,x:288.9,y:281.5},0).wait(1).to({rotation:94.7,x:335.4,y:352.9},0).wait(1).to({rotation:126,x:338.1,y:438},0).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-34.1,54.6,595.6,789.3);
// library properties:
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/elki_atlas_.png", id:"elki_atlas_"}
	],
	preloads: []
};
