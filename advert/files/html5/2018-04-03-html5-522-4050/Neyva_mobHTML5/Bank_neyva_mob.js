...
(lib.Синий = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({_off:false},0).wait(1).to({regX:101,regY:25.2,x:-301.8,y:-57.8},0).wait(1).to({y:-56.4},0).wait(1).to({y:-53.8},0).wait(1).to({y:-49.7},0).wait(1).to({y:-43.8},0).wait(1).to({y:-35.6},0).wait(1).to({y:-24.7},0).wait(1).to({y:-11.4},0).wait(1).to({y:2.8},0).wait(1).to({y:15.5},0).wait(1).to({y:25.2},0).wait(1).to({y:31.9},0).wait(1).to({y:36.1},0).wait(1).to({y:38.3},0).wait(1).to({regX:115.4,regY:31.2,x:-291.6,y:43.2},0).wait(207).to({y:43.3},0).wait(1).to({regX:101,regY:25.2,scaleX:0.71,scaleY:0.71,x:-301.7,y:39.3},0).wait(1).to({scaleX:0.73,scaleY:0.73,x:-301.5,y:40.4},0).wait(1).to({scaleX:0.76,scaleY:0.76,x:-301.1,y:42.6},0).wait(1).to({scaleX:0.82,scaleY:0.82,x:-300.5,y:46.5},0).wait(1).to({scaleX:0.9,scaleY:0.9,x:-299.5,y:52.4},0).wait(1).to({scaleX:1.01,scaleY:1.01,x:-298.2,y:60.3},0).wait(1).to({scaleX:1.12,scaleY:1.12,x:-297,y:67.5},0).wait(1).to({scaleX:1.19,scaleY:1.19,x:-296.2,y:72.3},0).wait(1).to({scaleX:1.23,scaleY:1.23,x:-295.7,y:75.1},0).wait(1).to({scaleX:1.25,scaleY:1.25,x:-295.5,y:76.4},0).wait(1).to({regX:115.2,regY:31.4,scaleX:1.25,scaleY:1.25,x:-277.5,y:84.2},0).wait(103));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(2).to({_off:false},0).wait(1).to({regX:70,regY:6.8,x:-301,y:-27.7},0).wait(1).to({y:-26.3},0).wait(1).to({y:-23.7},0).wait(1).to({y:-19.6},0).wait(1).to({y:-13.7},0).wait(1).to({y:-5.4},0).wait(1).to({y:5.6},0).wait(1).to({y:18.9},0).wait(1).to({y:33.2},0).wait(1).to({y:46},0).wait(1).to({y:55.8},0).wait(1).to({y:62.5},0).wait(1).to({y:66.7},0).wait(1).to({y:68.9},0).wait(1).to({regX:89.8,regY:8.7,x:-281.2,y:71.5},0).wait(210).to({regX:70,regY:6.8,scaleX:1.01,scaleY:1.01,x:-300.9,y:70.2},0).wait(1).to({scaleX:1.03,scaleY:1.03,x:-300.8,y:72.5},0).wait(1).to({scaleX:1.08,scaleY:1.08,x:-300.5,y:77},0).wait(1).to({scaleX:1.16,scaleY:1.16,x:-300.1,y:84.8},0).wait(1).to({scaleX:1.29,scaleY:1.29,x:-299.4,y:97},0).wait(1).to({scaleX:1.45,scaleY:1.45,x:-298.6,y:113},0).wait(1).to({scaleX:1.61,scaleY:1.61,x:-297.7,y:127.7},0).wait(1).to({scaleX:1.71,scaleY:1.71,x:-297.2,y:137.5},0).wait(1).to({scaleX:1.77,scaleY:1.77,x:-296.9,y:143.2},0).wait(1).to({scaleX:1.8,scaleY:1.8,x:-296.7,y:145.9},0).wait(1).to({regX:89.5,regY:8.8,scaleX:1.81,scaleY:1.81,x:-261,y:150.1},0).wait(103));

	// Symbol 14
	this.instance_3 = new lib.Symbol14();
	this.instance_3.setTransform(-303,-71,1,1,0,0,0,85,56);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({regX:87.5,regY:57,x:-300.5,y:-69.4},0).wait(1).to({y:-67.7},0).wait(1).to({y:-64.5},0).wait(1).to({y:-59.4},0).wait(1).to({y:-51.9},0).wait(1).to({y:-41.4},0).wait(1).to({y:-27.6},0).wait(1).to({y:-11.7},0).wait(1).to({y:3.7},0).wait(1).to({y:15.9},0).wait(1).to({y:24.3},0).wait(1).to({y:29.5},0).wait(1).to({y:32.3},0).wait(1).to({regX:85,regY:56,x:-303,y:32},0).wait(212).to({y:-108.7},11).wait(103));
...
(lib.Бизнесстарт = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.Bank_neyva490x375 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.btnMain).to({_off:true},340).wait(1));

	// Бизнес на старт
	this.instance = new lib.Бизнесстарт();
	this.instance.setTransform(244,258.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(341));

	// 321
	this.instance_1 = new lib._321();
	this.instance_1.setTransform(244.4,260.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(341));

	// Слой 5
	this.instance_2 = new lib.Синий();
	this.instance_2.setTransform(247.2,-46.7,1.716,1.716,0,0,0,-300.2,-69.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(341));

	// Слой 2
	this.instance_3 = new lib.Символ2();
	this.instance_3.setTransform(245.3,187.7,0.861,1.498,0,0,0,284.9,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90).to({x:100.5,alpha:0.648},11,cjs.Ease.get(1)).wait(124).to({x:-53.9,alpha:0},11,cjs.Ease.get(1)).wait(105));

	// Слой 1
	this.instance_4 = new lib.Символ1();
	this.instance_4.setTransform(245.3,187.4,0.506,1.494,0,0,0,485,125.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(341));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-294,42.8,1029.7,519.7);
