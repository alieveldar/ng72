...
<script type="text/javascript" src="/modules/standart/multiupload/client/uploader.js"></script>';
if ($dir[1]==2) { $text.="<b>Чтобы стать частью НАШЕГО сайта - бесценным блоггером, авторизуйтесь и через форму ниже пришлите нам пробный текст для вашего блога, НАША редакция его оценит и, возможно, именно вы станете нашим любимым блоггером и получите свой <a href='/blogs'>личный блог</a> на НАШЕМ сайте!</b>".$C10; }
$text.=$msg;
