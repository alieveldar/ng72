...
function getLentasOnModules() { global $lentas; if (sizeof($lentas)==0) { $modules=array("lenta","concurs"); $notin=array("vtorzhilio","world","uncensored","realestatenews","gadgets");
