...
//============================================================================================================================================================
function SocialGroups(){ global $BasVARS; $text=""; foreach($BasVARS as $k=>$val){ if ($val["stat"]==3 && $val["type"]=="var" && trim($val["value"])!="") { $text.="<li><a href='".$val["value"]."' rel='nofollow'><img src='/template/standart/social/".$val["name"].".gif'></a></li>"; }} if ($text!="") { $text="<noindex><ul id='SocialsGroupsUL'>".$text."</ul></noindex>";} return $text; }
//============================================================================================================================================================
...
function GetNormalVideo($text) { $text = preg_replace('~width="\d+"~', 'width="500"', $text); $text = preg_replace('~height="\d+"~', 'height="360"', $text); return $text; }
