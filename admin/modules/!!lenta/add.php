...
// СОХРАНЕНИЕ ПОЛЕЙ И ФОРМ
	...
	if (isset($P["savebutton"])) {
		...
		if($P["dtitle"]=="") { $P["dtitle"]=$P["dname"]; }
		$aliasid=translit(str_replace(".","-",$P["ddata1"])."-".str_replace("'", "\'", $P["dtitle"])); 
		
		$q="INSERT INTO `".$alias."_lenta` (`uid`, `bid`, `cat`, `name`,`title`,`alias`,`kw`, `ds`, `cens`, `realinfo`, `comments`, `data`, `astat`, `adata`, `promo`, `onind`, `spec`, `yarss`, `mailrss`, `tavto`, `tags`, `redak`,`gis`,`mailtizer`)
