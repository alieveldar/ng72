...
// СОХРАНЕНИЕ ПОЛЕЙ И ФОРМ
        ...
        if (isset($P["savebutton"])) {
            ...
            $q = "INSERT INTO `" . $alias . "_specprj` (`uid`, `bid`, `cat`, `name`,`title`,`alias`,`kw`, `ds`, `cens`, `realinfo`, `comments`, `data`, `astat`, `adata`, `promo`,`spromo`, `onind`, `spec`, `yarss`, `mailrss`, `tavto`, `tags`, `redak`,`gis`,`mailtizer`, `preview_mobile`, `vk_np`)
		...
		'" . $P["autoon"] . "', '" . $sdata2 . "', '" . $P["comrs"] . "','" . $P["scomrs"] . "','" . $P["ontv"] . "', '" . $P["spec"] . "', '" . $P["yarss"] . "', '" . $P["mailrss"] . "', '" . $P["tavto"] . "', '" . $dtags . "', '" . $P["redak"] . "', '" . $P["gis"] . "', '" . $P["mailtizer"] . "', '" . $P['preview_mobile'] . "', '" . $P['vk_np'] . "')";
            ...
            $data = DB($q);
            $last = DBL();
            DB("UPDATE `" . $alias . "_specprj` SET `rate`='" . $last . "' WHERE  (id='" . $last . "')");
            DB("INSERT INTO `_specprjlog` (`link`, `id`, `uid`, `data`, `ip`, `text`) VALUES ('" . $alias . "', '" . $last . "', '" . $_SESSION['userid'] . "', '" . time() . "', '" . $_SERVER['REMOTE_ADDR'] . "', 'Создание #" . $last . ": " . str_replace("'", '&#039;', $P["dname"]) . "')");
...
// ВЫВОД ПОЛЕЙ И ФОРМ
	...
	<tr class="TRLine1"><td class="VarText">Заголовок материала<star>*</star></td><td class="LongInput"><input name="dname" id="dname" type="text" class="JsVerify2" maxlength="120"></td><tr>
	<!--<tr class="TRLine0"><td class="VarText">Заголовок Яндекса<star>*</star></td><td class="LongInput"><input name="dtitle" id="dtitle" type="text" class="JsVerify2" maxlength="255"></td><tr>-->
	...
	<tr class="TRLine1 ShowSets"><td class="VarName">Ссылка на материал</td><td class="LongInput"><input name="realinfo" type="text"></td><tr>
	<!--<tr class="TRLine0 ShowSets"><td class="VarName">Комментарии</td><td class="LongInput"><div class="sdiv"><select name="comms"><option value="2">Чтение и добавление</option><option value="2">Только чтение</option><option value="2">Запретить комментарии</option></select></div></td><tr>-->	
	...
	<tr class='TRLine0'>
		<td width='1%'><input name='ontv' id='ontv' type='checkbox' value='1'></td><td width='20%'>Главная новость</b></td>
		<td width='1%'><input name='redak' id='redak' type='checkbox' value='1'></td><td width='20%'>Редакционная колонка</td>
		<td width='1%'><input name='tavto' id='tavto' type='checkbox' value='1' checked></td><td width='20%'>Выводить Фото в лентах</td>
	</tr>
	<tr class='TRLine1'>
		...
		<td width='1%'><input name='preview_mobile' id='mobile' type='checkbox' value='1'></td><td width='20%'>Отображается в мобильной версии</td>
		<!--<td width='1%'><input name='spec' id='spec' type='checkbox' value='1'></td><td width='20%'>Спец. размещение</td>-->
		<!--<td width='1%'><input name='gis' id='gis' type='checkbox' value='1'></td><td width='20%'>Отметить <b>«Главная новость»</b></td>-->
	</tr>
	<tr class='TRLine0'>
