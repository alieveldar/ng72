...
// СОХРАНЕНИЕ ПОЛЕЙ И ФОРМ
	...
	if (isset($P["savebutton"])) {
		...
		$q="UPDATE `".$alias."_specprj` SET `pay`='".str_replace("'", "\'", $P["lid"])."', `alttext`='".str_replace("'", "\'", $P["PostText"])."',
	...
	// ВЫВОД ПОЛЕЙ И ФОРМ
	$data=DB("SELECT `pay`, `endtext`, `alttext`, `adv`, `name`, `stat` FROM `".$alias."_specprj` WHERE (`id`='".(int)$id."') LIMIT 1");
