...
if ($_SESSION['userrole']>2) {
	...
	if ($R["act"]=="DEL") {
		...
		foreach($items as $item) { DB("INSERT INTO `_specprjlog` (`link`, `id`, `uid`, `data`, `ip`, `text`) VALUES ('".$link."', '".$item."', '".$_SESSION['userid']."', '".time()."', '".$_SERVER['REMOTE_ADDR']."', 'Удаление публикации (delete)')");	}
	}
