...
// СОХРАНЕНИЕ ПОЛЕЙ И ФОРМ
	...
	if (isset($P["savebutton"])) {
		...
		$q="INSERT INTO `".$alias."_lenta` (`uid`, `bid`, `cat`, `name`,`title`,`alias`,`kw`, `ds`, `cens`, `realinfo`, `comments`, `data`, `astat`, `adata`, `promo`,`spromo`, `onind`, `spec`, `yarss`, `mailrss`, `tavto`, `tags`, `redak`,`gis`,`mailtizer`)
