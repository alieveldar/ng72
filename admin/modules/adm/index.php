...
if ($GLOBAL["sitekey"]==1 && $GLOBAL["database"]==1) {
	...
	$AdminRight.="<h2>Календарь всех публикаций</h2>"; $defdata=""; if ($id!="" && isset($id)) { $tmp=explode(".", $id); $dirs=$tmp[0].".".$tmp[1].".".$tmp[2]; $defdata='$("#datepick5").datepicker("setDate", "'.$dirs.'")'; }
	$AdminRight.='<div id="datepick5" style="width:200px;"></div><script type="text/javascript">$("#datepick5").datepicker({ onSelect: function(dateText, inst) { document.location="?cat=adm_alldater&id="+dateText; }}); $.extend($.datepicker.regional["ru"]); $("#datepick5").datepicker("option","dateFormat","dd.mm.yy"); '.$defdata.'</script><div class="C20"></div>';
