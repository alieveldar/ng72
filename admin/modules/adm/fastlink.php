...
if ($GLOBAL["sitekey"]==1 && $GLOBAL["database"]==1) {
	...
	// ЭЛЕМЕНТЫ
	$AdminText.='<h2 style="float:left;">Короткие ссылки</h2><div style="float:right;" class="LinkG"><a href="javascript:void(0);" onclick="AddNewCross(\''.(int)$id.'\', \'0\');">Добавить ссылку</a></div>'
	.$_SESSION["Msg"].$C5."<div id='Msg2' class='InfoDiv'>Вы можете изменять ссылки</div>";
